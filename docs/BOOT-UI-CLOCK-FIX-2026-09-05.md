...
| Cold boot novo após essas mudanças | NÃO HOMOLOGADO — dois overlays novos permaneceram `offline` além de 300 s durante a varredura inicial do Package Manager |
