...
$contractChecks = [ordered]@{
    ...
    qmpShutdownRequiresPositiveEvidence = $qemuBenchmarkCommonSource -match 'QmpCapabilitiesSucceeded' -and $qemuBenchmarkCommonSource -match 'QmpShutdownSucceeded' -and $qemuBenchmarkCommonSource -match 'ForcedKill' -and $benchmarkSource -match 'qmpShutdownSucceeded' -and $persistenceSource -match 'firstQmpShutdownSucceeded' -and $checklistSource -match 'qmp-shutdown.*qmpShutdownSucceeded'
