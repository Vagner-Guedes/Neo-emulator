...
$contractChecks = [ordered]@{
    ...
    operationalHotkeysHaveReservedKeyFallback = $launcherSourceText -match 'WhKeyboardLl' -and $launcherSourceText -match 'SetWindowsHookEx' -and $launcherSourceText -match 'CustomKeyboardMessage' -and $launcherSourceText -match 'KeyboardHookCallback'
